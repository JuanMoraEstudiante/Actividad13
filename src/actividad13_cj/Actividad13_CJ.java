 ...
 * @author juanc
 */
public class Actividad13_CJ {
    
    private static String[] bancoPalabras = {"Hola", "Ballena", "Helado", "Pizza", "Hamburgesa",
        "Pasta", "Hotdog", "Arroz", "Ramen", "Picadillo", "Tacos", "Burritos", 
        "Verduras"};
    ...
    public static List<String> fillList(List list, int size){
        ...
        for(int i= 0; i<size; i++){
            list.add(bancoPalabras[rand.nextInt(bancoPalabras.length)]);
